<x-app-layout>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQMSXMH" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div class="relative min-h-96 text-yellow-400">
        ...
        <div class="relative py-24 xl:py-32 flex justify-center items-center uppercase">
            <h1 class="text-8xl xl:text-9xl font-mono text-center leading-relaxed tracking-wider"
                x-data="scrambledTitle()" x-html="scrambledTitle.replace(' ', '<br>')"></h1>
            <h2 class="absolute text-xl xl:text-3xl font-bold text-center tracking-widest mt-4 mx-auto my-auto">
                Umenovedná&nbsp;výprava</h3>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current absolute w-5 top-0 right-0 m-8">
            <path
                d="M10.684 10.684h7.945v3.29h-6.577v1.369h6.577v3.288h-7.945v-7.947zm0-8.349l6.979 6.98h-6.979v-6.98zm-9.316-.967h7.948v7.947H1.368V1.368zm10.285 0h6.976v6.981l-6.976-6.981zM0 0v10.684h9.316v7.947H1.368v-6.579H0V20h20V0H0z" />
        </svg>
    </div>
    <div class="container xl:text-shadow mx-auto py-8 px-8 sm:w-3/4 xl:w-1/2 overflow-hidden">
        <div class="text-center text-yellow-200 font-bold uppercase">
            ...
            <a class="inline-block mt-12 mb-10 py-4 px-6 bg-yellow-400 hover:bg-yellow-300 active:bg-yellow-200 focus:outline-none focus:shadow-outline text-pink-400 text-xl xl:text-xl text-shadow-none tracking-wider rounded-2xl"
                href="https://sng.us3.list-manage.com/subscribe?u=0836676badd21fd175052c757&id=5839efcae6&group%5B9800%5D%5B32%5D=true">
